...
XAMSRunActionMessenger::XAMSRunActionMessenger(XAMSRunAction *pRunAction):
...
XAMSRunActionMessenger::~XAMSRunActionMessenger()
{
	delete m_pDirectory;
}

void
XAMSRunActionMessenger::SetNewValue(G4UIcommand * command, G4String newValues)
{
